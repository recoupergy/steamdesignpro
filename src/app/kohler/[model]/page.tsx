  ...
  return (
    <main className="content-page model-page">
      ...
      <aside className="planning-notice">
        <strong>Not a selection approval.</strong> This is an independent source summary, not a statement of availability, suitability, affiliation, or manufacturer approval. Confirm the current product, manual, local code, and full design with KOHLER and licensed professionals.
      </aside>
